...
# occigen :
export NC_INC="-I /opt/cray/pe/modulefiles/cray-netcdf-hdf5parallel/4.7.4.2/include"
export NC_LIB="-L /opt/cray/pe/modulefiles/cray-netcdf-hdf5parallel/4.7.4.2/lib -lnetcdf -lnetcdff"
