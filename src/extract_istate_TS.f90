...
status = NF90_INQ_VARID(fidMSKIN,"x",lon_ID)    ; call erreur(status,.TRUE.,"inq_lon_PAR_ID")
!status = NF90_INQ_VARID(fidMSKIN,"nav_lat",lat_ID)    ; call erreur(status,.TRUE.,"inq_lat_PAR_ID")
status = NF90_INQ_VARID(fidMSKIN,"y",lat_ID)    ; call erreur(status,.TRUE.,"inq_lat_PAR_ID")
